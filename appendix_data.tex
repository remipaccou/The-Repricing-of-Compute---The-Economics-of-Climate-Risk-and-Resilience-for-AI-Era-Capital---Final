...
includes named, publicly documented projects: Major AI hyperscaler campus (US South, phased to
...
(Sovereign AI project, France, 250~MW, DataVolt NEOM SA 1.5~GW phased), large colocation expansions
...
Facility case studies & 72 & 592 & Three sites (Site~A, Site~B, Site~C) $\times$ 24 scenario combinations. 64 base columns + 528 time-series columns: 22 channel-hazard decompositions $\times$ 25 years. \\
\bottomrule
\end{tabular}
\end{table}

...
\end{center}
\exhibitsource{Radar overlay: each polygon is one facility's channel fingerprint (\% of site-level ClimVaR). Site~A stretches toward BI and Cooling; Site~B collapses onto Damage; Site~C is the most balanced. Overlaying the three profiles on a single chart makes the contrast between risk architectures immediately visible.}

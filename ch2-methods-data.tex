...
\noindent The three scenarios bracket the range of plausible AI infrastructure futures. \textbf{Limits to Growth} assumes energy constraints, semiconductor bottlenecks, and regulatory friction slow expansion to +63~GW by 2050. \textbf{Sustainable AI} assumes efficiency gains (hardware, algorithms, cooling) enable growth within environmental guardrails (+121~GW). \textbf{Abundance Without Boundaries} assumes compute demand scales with minimal constraint as AI becomes embedded across economic sectors (+296~GW). The gap between scenarios widens after 2035, when today's siting and design decisions will have locked in climate exposure for decades.

...
\noindent\textit{The ClimVaR framework translates physical hazards and transition risks into enterprise value loss at facility level. This chapter presents the valuation model and its two analytical tools (Section~1), the geocoded database (Section~2), and the scenario architecture (Section~3).}
...
$\xi$ & Heat productivity & Sustained heat waves & Outdoor labor and equipment efficiency\footnote{Equipment efficiency loss under sustained heat is not yet parameterized in the current model version. Integration is underway, as thermal derating of outdoor electrical and mechanical systems may be material at high-density sites.} \\
\midrule
...
% ---- Framework figure (right after channel table) ----
\vspace{2mm}
...
\subsection*{Scenario Architecture}
\greensep
